package com.yodgorbek.codelearnapp.domain.codeexecution

import com.yodgorbek.codelearnapp.data.remote.CodeExecutionService
            ...
            try {
                ...
                if (trimmed.startsWith("SELECT")) {
                    if (trimmed.contains("FROM USERS")) {
                        CodeExecutionResult.Success("| ID | Name | Email |\n|---|---|---|\n| 1 | Yodgorbek | yodgor@yodgorbek.com |\n| 2 | Ali | ali@yodgorbek.com |")
                    } else {
