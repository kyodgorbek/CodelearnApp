package com.yodgorbek.codelearnapp.data.remote

import com.yodgorbek.codelearnapp.domain.model.CodeExecutionRequest
import com.yodgorbek.codelearnapp.domain.model.CodeExecutionResponse
    ...
    suspend fun executeCode(request: CodeExecutionRequest): CodeExecutionResponse {
        return try {
            ...
            val pistonRequest = PistonRequest(
                ...
                files = listOf(PistonFile(name = request.fileName ?: "Main.java", content = request.script)),
                stdin = request.stdin
            )
